...
public class IndexData5Test {
    ...
    public void testGetClass3(){
         ...
         */
        String statement = "models.dao.mapping.classMapper.getClass3";//映射sql的标识字符串
    ...
    public void testGetClass4(){
         ...
         */
        String statement = "models.dao.mapping.classMapper.getClass4";//映射sql的标识字符串
        //执行查询操作，将查询结果自动封装成Classes对象返回
        Classes clazz = sqlSession.selectOne(statement,1);//查询class表中id为1的记录
        //使用SqlSession执行完SQL之后需要关闭SqlSession
        sqlSession.close();
